...
{/* <div>
<input type="button" value="AC" onclick="display.value=''" class="ACDE">
<input type="button" value="DE" onclick="display.value=display.value.toString().slice(0,-1)" class="ACDE">
<input type="button" value="." onclick="display.value+='.'" class="ACDE">
<input type="button" value="/" onclick="display.value+='/' " class="ACDE">
</div> */}
...
<input type="button" value="=" id="eq" onclick="display.value=eval(display.value)" class="operator ACDE" >
</div> */}
...
// document.body.append(num12_div_tag);
